          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                @endif --}}
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('staff pemeriksaan')}}">
                    @csrf
                  <div class="card-body">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nama</label>
                        <input type="text" name="type" class="form-control" id="exampleFormControlInput1" 
                        placeholder="Masukkan Nama" value="{{old('type')}}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        placeholder="Masukkan Nilai Rujukan" value="{{old('rujukan')}}">
                    </div> 
